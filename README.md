...
<p align="center">
<img src="https://user-images.githubusercontent.com/63164037/136659010-b6553d4a-b480-4bfc-9423-39ce8531c70f.png">
</p>

## 📜 Description:
Sending email manually was too tedius task, most importantly it was too time-consuming and error prone. So i tried to automated way to send out your emails automatically using python script.

## 🧪 Steps to Build locally:
- Open Android Studio IDE.
- Clone with `git clone https://github.com/aditya-190/Bulk-Email-Sending-Script`.
...
- Take a look at the Existing [Issues](https://github.com/aditya-190/Bulk-Email-Sending-Script/issues) or create your own Issues!
